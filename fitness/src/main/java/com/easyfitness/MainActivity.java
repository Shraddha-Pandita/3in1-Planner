...
public class MainActivity extends AppCompatActivity {
    ...
    private PopupMenu.OnMenuItemClickListener onMenuItemClick = item -> {
        ...
        if (itemId == R.id.create_newprofil) {
            getActivity().CreateNewProfil();
            return true;
        } else if (itemId == R.id.change_profil) {
            ...
            return true;
        } else if (itemId == R.id.delete_profil) {
            ...
            return true;
        } else if (itemId == R.id.rename_profil) {
            getActivity().renameProfil();
            return true;
        } else if (itemId == R.id.param_profil) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.export_database) {
            exportDatabase();
            return true;
        } else if (itemId == R.id.import_database) {// Create DirectoryChooserDialog and register a callback
            ...
            return true;
        } else if (itemId == R.id.action_deleteDB) {// Afficher une boite de dialogue pour confirmer
            ...
            return true;
        } else if (itemId == R.id.action_apropos) {// Display the fragment as the main content.
            showFragment(ABOUT);
            ...
            //onBackPressed();
            //	return true;
        } else if (itemId == R.id.action_chrono) {
