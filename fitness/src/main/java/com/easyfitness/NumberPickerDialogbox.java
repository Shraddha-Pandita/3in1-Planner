...
public class NumberPickerDialogbox extends Dialog implements
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.btn_ok) {//dismiss();
        } else if (id == R.id.btn_cancel) {
            dismiss();
        } else if (id == R.id.btn_minusOne) {//dismiss();
        } else if (id == R.id.btn_plusOne) {//dismiss();
        } else if (id == R.id.btn_minusFive) {//dismiss();
        } else if (id == R.id.btn_plusFive) {//dismiss();
        }
    }
/*
